...
public class SettingEnumWidget extends Widget {
    ...
    public SettingEnumWidget(ModuleClickGUI master, CategoryFrame frame, ModuleScrollContainer container, ModuleWidget module, final ValueEnum setting) {
    ...
    public void onRender() {
         ...
         * Render module name.
         */
        TurokFontManager.render(this.master.fontWidgetModule,(!this.rect.getTag().isEmpty() ? this.rect.getTag() + ": " : this.rect.getTag()) + this.setting.getValue().name(), this.rect.getX() + 1, this.rect.getY() + 3, true, new Color(255, 255, 255));
    }
